...
const AddForm = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (data.type === "non-document" && !data.weight) {
      Swal.fire(
        "Missing Field",
        "Parcel Weight is required for non-document type.",
        "error"
      );
      return;
    }
    ...
    Swal.fire({
          ...
          <table style="width:100%; border-collapse: collapse; font-size: 14px; text-align:left;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="border:1px solid #ccc; padding: 8px;">${
                  data.type === "document" ? "N/A" : `${weight} kg`
                }</td>
              </tr>
              <tr>
      ...
      if (result.isConfirmed) {
        ...
        axiosSecure
          .post("/add-parcels", finalData)
          .then((res) => {
            if (res.data.insertedId) {
              // Save tracking history
              axiosSecure.post(`/tracking/${trackingId}`, {
                stage: "parcel created",
                description: `Parcel created by ${user?.email}`,
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-6">
        Door to Door delivery requires pickup and delivery locations
      </p>
